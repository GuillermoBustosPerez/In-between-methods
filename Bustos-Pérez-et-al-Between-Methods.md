...
knapper. Levallois ([1995a](#ref-dibble_levallois:_1995),
[1994](#ref-boeda_concept_1994), [1993](#ref-boeda_debitage_1993);
[Boëda et al., 1990](#ref-boeda_identification_1990)) products belong to
the preferential and recurrent centripetal modalities. Hierarchical
...
Discoidal ([Boëda, 1993](#ref-boeda_debitage_1993); [Terradas,
2003](#ref-terradas_discoid_2003); [Thiébaut,
2013](#ref-thiebaut_discoid_2013)) products belong to the *sensu
...
![](Bustos-Pérez-et-al-Between-Methods_files/figure-markdown_github/Cortex%20per%20knapping%20method-1.png)
...
![](Bustos-Pérez-et-al-Between-Methods_files/figure-markdown_github/Bagolini%20scatter%20plot-1.png)
...
-   Width at the 75% length of the flake ([Eren and Lycett,
    2012](#ref-eren_why_2012)).  
-   Thickness at the 25% length of the flake ([Eren and Lycett,
    2012](#ref-eren_why_2012)).  
-   Thickness at the 50% length of the flake ([Eren and Lycett,
    2012](#ref-eren_why_2012)).  
...
flake. Right: calculation of flake curvature following
...
-   **Linear Discriminant Analysis (LDA)**: reduces dimensionality
    aiming to maximize separation between classes while decision
...
-   **Random Forest**: are made of decision trees. Each tree is grown
...
-   **Artificial Neural Network (ANN)** with multi-layer perception
    which uses a series of hidden layers and error backpropagation for
...
implies obtaining the mean of several AUC’s ([Hand and Till,
...
with MASS ([Venables and Ripley, 2002](#ref-venables_modern_2002)). The
training of random forest was done using the “ranger” package ([Wright
and Ziegler, 2017](#ref-wright_ranger_2017)). The training of SVM was
done using the e1071 package ([Karatzoglou et al.,
...
![](Bustos-Pérez-et-al-Between-Methods_files/figure-markdown_github/ROC%20and%20AUC%20of%20each%20class-1.png)
...
![](Bustos-Pérez-et-al-Between-Methods_files/figure-markdown_github/Confusion%20Matrix-1.png)
...
![](Bustos-Pérez-et-al-Between-Methods_files/figure-markdown_github/Variable%20importance-1.png)
...
![](Bustos-Pérez-et-al-Between-Methods_files/figure-markdown_github/Cortex%20and%20class%20probabilities-1.png)
...
has been previously noted by different authors. [Lenoir and
Turq](#ref-dibble_recurrent_1995) ([1995](#ref-dibble_recurrent_1995))
propose the use of the term “recurrent centripetal” as to include both
discoidal debitage and Levallois recurrent centripetal and that
Levallois (sensu stricto) should be limited to preferential and
recurrent lineal modalities. Similarly, [Casanova et
al.](#ref-casanova_debitage_2014) ([2014](#ref-casanova_debitage_2014))
...
([2003](#ref-peresani_discoiou_2003)) situates the Hierarchical Discoid
knapping method in the margins of the Discoid group, given their
...
([2021](#ref-archer_quantifying_2021)) use 3D geometric morphometrics
for the identification of three distinct knapping methods (Laminar,
Discoid and Levallois) and indicate a general success between 73% and
77% with Levallois flakes showing the highest identification rate (87%)
and Discoid flakes the lowest (40%). The overall higher precision
reached by [Archer et al.](#ref-archer_quantifying_2021)
...
flakes is minimal. [González-Molina et
al.](#ref-gonzalez-molina_distinguishing_2020)
...
et al.](#ref-gonzalez-molina_distinguishing_2020)
([2020](#ref-gonzalez-molina_distinguishing_2020)) report a 90%
...
Levallois flake” ([Debénath and Dibble,
1994](#ref-debenath_handbook_1994); [Hovers,
2009](#ref-hovers_lithic_2009)). [González-Molina et
al.](#ref-gonzalez-molina_distinguishing_2020)
...
retouch ([Shott and Seeman, 2017](#ref-shott_use_2017)), making them a
less desirable variable for the identification of knapping methods.
...
production systems ([Boëda, 1995a](#ref-dibble_levallois:_1995),
[1994](#ref-boeda_concept_1994); [Bourguignon,
1997](#ref-bourguignon_mousterien_1997); [González-Molina et al.,
2020](#ref-gonzalez-molina_distinguishing_2020); [Lenoir and Turq,
...
1995a](#ref-dibble_levallois:_1995), [1993](#ref-boeda_debitage_1993);
[Kelly, 1954](#ref-kelly_contribution_1954); [Lenoir and Turq,
1995](#ref-dibble_recurrent_1995); [Soriano and Villa,
2017](#ref-soriano_early_2017); [Terradas,
2003](#ref-terradas_discoid_2003)). In the present experimental sample
...
acknowledged ([Davis and Shea, 1998](#ref-davis_quantifying_1998);
[Dibble and Pelcin, 1995](#ref-dibble_effect_1995)), the present study
states its importance for the determination of knapping methods.  
...
preparation for the differentiation of knapping strategies ([Lenoir and
...
platform preparation ([Driscoll and García-Rojas,
...
debate ([Faivre et al., 2017](#ref-faivre_late_2017); [Grimaldi and
...
for the study of lithic technology ([Soressi and Geneste,
...
Archaeology of Wardaman Country, Northern Territory, Terra australis.
...
Dibble, H.L., 1989. The Implications of Stone Tool Types for the
Presence of Language During the Lower and Middle Palaeolithic, in:
Mellars, P., Stringer, C. (Eds.), The Human Revolution: Behavioural and
Biological Perspectives on the Origins of Modem Humans. Edinburgh
University Press, Edinburgh, pp. 415–432.
...
Science 47, 134–141. <https://doi.org/10.1016/j.jas.2014.04.008>
...
55, 952–961. <https://doi.org/10.1016/j.jhevol.2008.07.009>
...
<https://doi.org/10.1006/jasc.2001.0705>
...
Laplace, G., 1968. Recherches de typologie analytique 1968. Origini II,
7–64.
...
Southeast Asia. Journal of Archaeological Science 35, 1189–1200.
<https://doi.org/10.1016/j.jas.2007.08.007>
...
Fourth Edition. ed, Statistics and Computing. Springer, New York.
